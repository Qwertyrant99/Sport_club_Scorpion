window.addEventListener('DOMContentLoaded', () => {
    ...
    getResource('http://localhost:3000/taekwondo_coaches')
        .then(data => {
            data.forEach(({
                img,
                altimg,
    ...
    getResource('http://localhost:3000/boxing_coaches')
        .then(data => {
            data.forEach(({
                img,
                altimg,
    ...
    getResource('http://localhost:3000/kickboxing_coaches')
        .then(data => {
            data.forEach(({
                img,
                altimg,
    ...
    getResource('http://localhost:3000/gym_coaches')
        .then(data => {
            data.forEach(({
                img,
                altimg,
